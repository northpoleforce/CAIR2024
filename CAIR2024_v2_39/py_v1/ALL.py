...
#########  卸货（狗尾部的容器）BEGIN   ###########
    ...
    swift.set_servo_angle(2,0)  # 机械臂上抬
    time.sleep(1)
    swift.set_servo_angle(1,65)  # 机械臂向前伸
    time.sleep(1)
    swift.set_servo_angle(2,28)  # 机械臂下降
    time.sleep(2)
    swift.set_wrist(180)         # 夹爪闭合
    time.sleep(1)
    swift.set_servo_angle(2,0)   # 机械臂上抬
    time.sleep(2)
    swift.set_servo_angle(0,10)  # 底座左右移动                 ### Finish
    time.sleep(3)
    swift.set_servo_angle(1,30)  # 机械臂向前伸
    time.sleep(2)
    swift.set_servo_angle(2,50)  # 机械臂下降
    time.sleep(2)
    swift.set_wrist(80)          # 夹爪张开
    time.sleep(1)
    swift.set_servo_angle(2,0)  # 机械臂上抬
...
#########  装货（狗尾部的容器）BEGIN   ###########
    ...
    swift.set_wrist(80)  # 夹爪张开
    swift.set_servo_angle(0,0)  # 底座左右移动
    time.sleep(3)
    swift.set_servo_angle(1,30)  # 机械臂向前伸
    time.sleep(3)
    swift.set_servo_angle(2,55)  # 机械臂下降
    time.sleep(3)
    swift.set_wrist(180)         # 夹爪闭合
    time.sleep(1)
    swift.set_servo_angle(2,0)  # 机械臂上抬
    ...
    swift.set_servo_angle(1,65)  # 机械臂向前伸
    time.sleep(2)
    swift.set_servo_angle(2,25)  # 机械臂下降
    time.sleep(2)
    swift.set_wrist(80)          # 夹爪张开
    time.sleep(1)
    swift.set_servo_angle(2,0)  # 机械臂上抬
...
########  卸货（狗前部的容器）BEGIN   ###########
    ...
    swift.set_servo_angle(2,0)  # 机械臂上抬
    time.sleep(1)
    swift.set_servo_angle(1,120)  # 机械臂向后缩
    time.sleep(1)
    swift.set_servo_angle(2,28)  # 机械臂下降
    time.sleep(2)
    swift.set_wrist(180)         # 夹爪闭合
    ...
    swift.set_servo_angle(1,90)  # 机械臂向前伸
    time.sleep(2)                                                       ##  Finish
    swift.set_servo_angle(0,10)  # 底座左右移动
    time.sleep(3)
    swift.set_servo_angle(1,30)  # 机械臂向前伸
    time.sleep(2)
    swift.set_servo_angle(2,50)  # 机械臂下降
...
#########  装货（狗前部的容器）BEGIN   ###########
    ...
    swift.set_wrist(80)  # 夹爪张开
    swift.set_servo_angle(0,25)  # 底座左右移动
    time.sleep(3)
    swift.set_servo_angle(1,30)  # 机械臂向前伸
    time.sleep(3)
    swift.set_servo_angle(2,60)  # 机械臂下降
    time.sleep(3)
    swift.set_wrist(180)         # 夹爪闭合
    time.sleep(1)
    ...
    time.sleep(2)
    swift.set_servo_angle(2,20)  # 机械臂下降
    time.sleep(2)
    swift.set_wrist(80)          # 夹爪张开
    time.sleep(1)
    swift.set_servo_angle(2,0)  # 机械臂上抬
